insert into VENUE (
    ID, VENUE_NAME, LINK_MORE_INFO, CAPACITY,OPPERVLAKTEINMM,KOSTPRIJSPA)
values (
           1, 'De Club', 'https://transitm.mechelen.be/de-club',150,200,500);
insert into VENUE (
    ID, VENUE_NAME, LINK_MORE_INFO, CAPACITY,OPPERVLAKTEINMM,KOSTPRIJSPA)
values (
           2, 'De Loods', 'https://transitm.mechelen.be/de-loods',1000,200,500);
insert into VENUE (
    ID, VENUE_NAME, LINK_MORE_INFO, CAPACITY,OPPERVLAKTEINMM,KOSTPRIJSPA)
values (
           3, 'Zapoi', 'http://www.kafeezapoi.be',150,200,500);
insert into VENUE (
    ID, VENUE_NAME, LINK_MORE_INFO, CAPACITY,OPPERVLAKTEINMM,KOSTPRIJSPA)
values (
           4, 'De Kuub', 'http://www.dekuub.be',150,200,500);
insert into VENUE (
    ID, VENUE_NAME, LINK_MORE_INFO, CAPACITY,OPPERVLAKTEINMM,KOSTPRIJSPA)
values (
           5, 't''Ile Maline', 'https://www.tilemalines.be',400,200,500);
insert into VENUE (
    ID, VENUE_NAME, LINK_MORE_INFO, CAPACITY,OPPERVLAKTEINMM,KOSTPRIJSPA)
values (
           6, 'Nekkerhal',
           'https://www.nekkerhalbrusselsnorth.com/nl/organiseer/hal/',8800,200,500);
INSERT INTO ARTIST (
